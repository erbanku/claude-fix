...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    // #f08e66 - gpt-title
    'gpt-title': 'text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-orange-400 to-yellow-500',
    // 'gpt-subtitle': 'text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-purple-400 to-orange-600', //Purple to Orange
    // Orange to Yellow
    'gpt-subtitle': 'text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-orange-400 to-yellow-500',
